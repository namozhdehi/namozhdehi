...
<div align="center">
  <img src="https://github.com/namozhdehi/DC-Smart-Travel-Planner/blob/main/outputs/dc_top_attractions_map.png?raw=true" alt="GIS Portfolio" width="100%">
</div>
...
- 🚀 Developing **AWS-based GIS workflows** with Lambda, S3, and Step Functions
...
<table>
  <tr>
    <td width="50%" valign="top" align="center">
      ...
      <p><strong>Real-time routing for utility outage response</strong></p>
      <p>
        <a href="https://namozhdehi.github.io/utility-emergency-response-routing-analysis/">
          <img src="https://img.shields.io/badge/Live_Demo-2ea44f?style=for-the-badge&logo=googlemaps&logoColor=white" alt="Live Demo">
        </a>
      ...
      <p><em>Interactive GIS web app with outage severity, OSRM routing, service coverage areas, and DC boundary validation.</em></p>
    </td>

    <td width="50%" valign="top" align="center">
      <h3>🏙️ Mapping the Unseen City DC</h3>
      <p><strong>LiDAR-driven terrain and bikeability analysis</strong></p>
      <p>
        <a href="https://github.com/namozhdehi/mapping-the-unseen-city-dc">
          <img src="https://img.shields.io/badge/View_Project-2ea44f?style=for-the-badge&logo=github&logoColor=white" alt="View Project">
        </a>
      </p>
      <p>
        <img src="https://img.shields.io/badge/QGIS-589632?style=flat-square&logo=qgis&logoColor=white">
        ...
        <img src="https://img.shields.io/badge/Slope_Analysis-FF6B35?style=flat-square">
      </p>
      <p><em>Terrain modeling project using DEM, slope classification, and urban mobility analysis to identify bike-friendly areas.</em></p>
    </td>
  </tr>
  ...
  <tr>
    <td width="50%" valign="top" align="center">
      ...
      <p><strong>Accessibility analysis for EV infrastructure planning</strong></p>
      <p>
      ...
      <p>
        ...
        <img src="https://img.shields.io/badge/Rasterio-8B4513?style=flat-square">
        <img src="https://img.shields.io/badge/Spatial_Analysis-FF6B6B?style=flat-square">
      </p>
      <p><em>Geospatial workflow for identifying underserved EV charging areas using accessibility modeling and spatial analysis.</em></p>
    </td>

    <td width="50%" valign="top" align="center">
      <h3>🗺️ DC Smart Travel Planner</h3>
      <p><strong>Interactive attraction clustering and travel planning</strong></p>
      <p>
      ...
      <p>
        ...
        <img src="https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white">
        <img src="https://img.shields.io/badge/Leaflet-199900?style=flat-square&logo=leaflet&logoColor=white">
        <img src="https://img.shields.io/badge/OSM-7EBC6F?style=flat-square">
      </p>
      <p><em>Map-based planner using spatial clustering, attraction scoring, and interactive Leaflet visualization for Washington, DC.</em></p>
    </td>
  </tr>
</table>
