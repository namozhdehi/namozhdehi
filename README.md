...
<em>
Interactive GIS web app with outage severity, OSRM routing,
service coverage areas, and DC boundary validation.
</em>
...
<strong>LiDAR-driven terrain and bikeability analysis</strong>
...
<em>
Terrain modeling project using DEM, slope classification,
and urban mobility analysis to identify bike-friendly areas.
</em>
...
<strong>Accessibility analysis for EV infrastructure planning</strong>
...
<em>
Geospatial workflow for identifying underserved EV charging
areas using accessibility modeling and spatial analysis.
</em>
...
<strong>Interactive attraction clustering and travel planning</strong>
...
<em>
Map-based planner using spatial clustering,
attraction scoring, and interactive Leaflet visualization
for Washington, DC.
</em>
